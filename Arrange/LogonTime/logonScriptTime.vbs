...
If WScript.Arguments.Count = 1 Then
	 TimeStamp = WScript.Arguments.Item(0)
	 If Len(TimeStamp) <> 17 Then
		If Verbose = 1 Then Wscript.Echo "Timestemp Not in the right length. Aborting..."
		wscript.quit
	 End if
Else
	 If Verbose = 1 Then Wscript.Echo "Wrong number of params was sent. Aborting..."
	 Wscript.Quit
End If
